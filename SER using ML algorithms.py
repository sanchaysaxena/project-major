...
print("[DT] Accuracy Score:", accuracy_score(y_true=y_test,y_pred=dtree_predictions))
...
print("[SVM] Accuracy Score:", accuracy_score(y_true=y_test, y_pred=svm_predictions))
...
print("[RF] Accuracy Score:", accuracy_score(y_true=y_test,y_pred=c_p))
